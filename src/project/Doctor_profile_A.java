...
public class Doctor_profile_A extends JFrame {
	...
	public static void Doctor_profile_A() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Doctor_profile_A frame = new Doctor_profile_A();
	 ...
	 * Create the frame.
	 */
	public Doctor_profile_A() {
		setTitle("Profile");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 307, 395);
		...
		JLabel label = new JLabel("18004");
		label.setBounds(81, 30, 126, 14);
