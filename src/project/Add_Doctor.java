...
public class Add_Doctor extends JFrame {
	...
	public static void Add_Doctor(final Doctor d) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Add_Doctor frame = new Add_Doctor(d);
					frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public Add_Doctor(final Doctor d) {
		...
		contentPane.add(txt3);
		txt3.setColumns(10);
		txt3.setText(Integer.toString(d.getAge()));
		...
		contentPane.add(txt4);
		txt4.setColumns(10);
		txt4.setText(d.getEmail());
		
		txt5 = new JTextField();
		txt5.setBounds(81, 161, 181, 39);
		contentPane.add(txt5);
		txt5.setColumns(10);
		txt5.setText(d.getAddress());
		...
		btnSignup.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					String q = "Update doctor set name = '"+name+"', password = '"+pass+"', address = '"+address
							+"', email = '"+email+"', gender = '" +gender+"', position ='"+pos+"', appt_time = '"+a.apt+"', dept = "+dep+", roomno = "+room+", age = "+age+" "
							+"where id = " + id;
		...
		contentPane.add(txt6);
		txt6.setColumns(10);
		txt6.setText(Integer.toString(d.getDeptid()));
		
		txt7 = new JTextField();
		txt7.setBounds(81, 249, 181, 20);
		contentPane.add(txt7);
		txt7.setColumns(10);
		txt7.setText(d.getPosition());
		
		txt8 = new JTextField();
		txt8.setBounds(81, 287, 181, 20);
		contentPane.add(txt8);
		txt8.setColumns(10);
		txt8.setText(Integer.toString(d.getRoomno()));
